...
describe('v2beta2.CloudTasksClient', () => {
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.setIamPolicy
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.setIamPolicy
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.testIamPermissions
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.testIamPermissions
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getTask', () => {
        it('invokes getTask without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.getTask
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.getTask
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createTask', () => {
        it('invokes createTask without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.createTask
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.createTask
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteTask', () => {
        it('invokes deleteTask without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.deleteTask
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.deleteTask
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('leaseTasks', () => {
        it('invokes leaseTasks without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.leaseTasks
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.leaseTasks
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('acknowledgeTask', () => {
        it('invokes acknowledgeTask without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.acknowledgeTask
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.acknowledgeTask
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('renewLease', () => {
        it('invokes renewLease without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.renewLease
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.renewLease
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('cancelLease', () => {
        it('invokes cancelLease without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.cancelLease
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.cancelLease
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('runTask', () => {
        it('invokes runTask without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.runTask
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.runTask
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('listQueues', () => {
        it('invokes listQueues without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.listQueues
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.listQueues
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('uses async iteration with listQueues without error', async () => {
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(client.descriptors.page.listQueues.asyncIterate
    ...
    describe('listTasks', () => {
        it('invokes listTasks without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.listTasks
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.listTasks
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('uses async iteration with listTasks without error', async () => {
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(client.descriptors.page.listTasks.asyncIterate
                .getCall(0).args[1], request);
    ...
    describe('listLocationsAsync', () => {
        it('uses async iteration with listLocations without error', async () => {
            ...
            assert.deepStrictEqual(client.locationsClient.descriptors.page.listLocations.asyncIterate
                .getCall(0).args[1], request);
            assert(client.locationsClient.descriptors.page.listLocations.asyncIterate
                .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(expectedHeaderRequestParams));
        });
